...
namespace Foundatio.HostingSample {
    public class Program {
        ...
        public static IWebHostBuilder CreateWebHostBuilder(string[] args) {
            ...
            bool evenHours = args.Length == 0 || args.Contains("evenMinutes", StringComparer.OrdinalIgnoreCase);
            ...
            var builder = WebHost.CreateDefaultBuilder(args)
                ...
                .ConfigureServices(s => {
                    ...
                    if (evenHours)
                        s.AddCronJob<EvenMinutesJob>("0 */4 * * *");

                    if (sample1)
                        s.AddJob<Sample1Job>(o => o.ApplyDefaults().WaitForStartupActions(true).InitialDelay(TimeSpan.FromHours(4)));
